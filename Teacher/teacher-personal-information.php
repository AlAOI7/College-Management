...
<head>
    <title>المعلومات الشخصية للدكتور</title>
</head>
    ...
    <main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 main-background mb-2 w-100">
        <div class="sub-main">
            <div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-4 text-white admin-dashboard pl-3">
                <h4 class="">تعديل معلومات الدكتور</h4>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <form action="teacher-personal-information.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">الفب:*</label>
                                    <input type="text" class="form-control" name="father_name" placeholder="ادخل القب"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">المؤهل</label>
                                    <input type="text" class="form-control" name="last_qualification"
                                        placeholder="Last Qualifiacation"
                                        value=<?php echo $row['last_qualification'] ?>>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">الولايه او المقاطعه: *</label>
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-5 mt-3">
                                <button type="submit" name="sub" class="btn btn-primary">تعديل المعلومات</button>
                            </div>
                        </div>
                    </form>
                </div>

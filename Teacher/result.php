      ...
      for($i=0;$i<count($mark);$i++){
        ...
        $sid=$sid1[$i];
          ...
          value('$resultlevelida','$sid','$resultstudida','$mar','$yearidd','$sectioniddd')");
            ...
            value('$resultlevelida','$sid','$resultstudida','$mar','$yearidd','$sectioniddd')");
    if ($query) {
      echo "<script> alert('New result added...!!!') </script>";
             ...
             <div class="container-scroller">
                             ...
                             <div class="page-header">
                                 ...
                                 <nav aria-label="breadcrumb">
                                     <ol class="breadcrumb">
                                         ...
                                         <li class="breadcrumb-item active" aria-current="page"> اضافة نتيجة الطلاب
                                         </li>
                                     </ol>
                                 </nav>
                             </div>
                ...
                { 
                 ...
                 ?>
                                             ...
                                             <h4 class="card-title" style="text-align: center;"> اضافة نتائج الطلاب
                                                 للعام الدراسي
                                  ...
                                  ?>
                                             <form class="forms-sample" action="" enctype="multipart/form-data"
                                                 ...
                                                 <div class="form-group  row mb-3">
                                                     <label for="default" class="col-sm-2 control-label"> العام الدراسي
                                                     </label>
                                                     <div class="col-xl-10">
                                                 ...
                                                 <div class="form-group  row mb-3">
                                                     <label for="default" class="col-sm-2 control-label"> الفصل
                                                         الدراسي</label>
                                                     <div class="col-xl-10">
                              ...
                              $num11 = $rs11->num_rows;
                                while ($rows11 = $rs11->fetch_assoc())
                                  {?>
                                                 <div class="form-group  row mb-3">
                                                     ...
                                                     <div class="col-xl-10">
                                                         <input type="hidden" name="id[]"
                                                             value="<?php echo $rows11['id']; ?>">
                                                         <input type="text" name="marks[]" class="form-control"
                                                             id="marks" value="<?php echo $rows11['avregtotal'];?>"
                                                             maxlength="5" required="" placeholder="ادخل الدرجه من 100"
                                                             autocomplete="off">
                                                     </div>
                                                 </div>
                                                 <?php 
                                             ...
                                             <?php   } else {          ?>
                                             <form class="forms-sample" action="result.php"
                                                 enctype="multipart/form-data" method="POST">
                                                 <div class="form-group  row mb-3">
                                                     <!-- العام الدراسي -->
                                                     <div class="col-xl-6">
                                                         <label for="exampleInputName1"> العام الدراسي </label>
                                                         <select name="yearsid" class="form-control"
                                                             required="required">
                                                             <?php
                                                         ...
                                                         <table class="table align-items-center table-flush table-hover"
                                                             ...
                                                             <thead class="thead-light">
                                                                 <tr>
                                                                     ...
                                                                     <th class="font-weight-bold">العلامة</th>
                                                                 </tr>
                                                             </thead>

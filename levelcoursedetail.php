            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ol class="tg-breadcrumb">
                        ...
                        <li><a href="javascript:void(0);">المستوى الاول </a></li>
                                ...
                                <article class="tg-themepost tg-course">
                                    <div class="tg-themepostcontent">
                                        ...
                                        <div class="tg-themeposttitle">
                                            <h1>متطلبات الطالب لبيانات المستوى الاول</h1>
                                        </div>
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="relateddocuments">
                                                ...
                                                <ul class="tg-relateddocuments">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a class="tg-btndownload"
                                                            href="admin/filelevel/<?=$row['filename'];?>.<?=$row['type'];?>"><i

...
if (isset($_POST['sub'])) {
	...
	for ($i=0; $i < $count; $i++) {  
		$date=date("d-m-y");
		$que="insert into student_attendance(namecourse,subject_code,semester,student_id,attendance,attendance_date)values('".$_POST['namecourse'][$i]."','".$_POST['subject_code'][$i]."','".$_POST['semester'][$i]."','".$_POST['roll_no'][$i]."','".$_POST['attendance'][$i]."','$date')";
							...
							<div class="row mt-3">
								<div class="col-md-4">
									<div class="form-group" style="z-index: 10;">
										...
										<select class="browser-default custom-select" name="namecourse">
											<option >اختار </option>
											<?php
											$teacher_id=$_SESSION['teacher_id'];
											$query="select distinct(namecourse) as namecourse from course";
							...
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								$count=0;
									...
									if (isset($_POST['submit'])) {
										...
										$que="select student_info.roll_no,first_name,middle_name,last_name,student_courses.semester,student_courses.namecourse,subject_code from student_courses inner join student_info on student_info.roll_no=student_courses.roll_no where student_courses.namecourse='$namecourse' and student_courses.semester='$semester' and student_courses.subject_code='$subject_code'";
									...
									?>
										...
										<tr>
											...
											<input type="hidden" name="namecourse[]" value=<?php echo $row['namecourse'] ?> >

<?php  
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($_FILES['image']['name']) {
            ...
            $sql = "UPDATE newcolleg SET title = '$title',date='$date', description='$description',title1='$title1', image = '$image'";
        } else {
            // استخدم استعلام SQL بدون تحديث الصورة
            $sql = "UPDATE newcolleg SET title = '$title',date='$date', description='$description',title1='$title1',";
        }

        ...
        <div class="col-md-12">
            <div class="card">
                <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="card-body">
                        <h4 class="card-title"> صفحة المحاضرات </h4>
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = mysqli_query(   $conn, "INSERT INTO lectures (room_number, room_name, teacher_name,levelid,building,course_id, day_id, lecture_date, lecture_time)
                             VALUES ('$room_number', '$room_name', '$teacher_name','$levelid','$building','$course_id', '$day_id', '$lecture_date', '$lecture_time')"  );
                       
                            if ($sql) {
                                echo "<script> alert('اضافة الى صفحة المحاضرات...!!!') </script>";
                                echo "<script> location = 'edit_lectures.php' </script>";
                            }
                        }
                        ?>
                        <?php
                        $sql = mysqli_query($conn, 'SELECT * FROM lectures');
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-9">
                                <input name="room_name" type="room_name" class="form-control" id="room_name"
                                    value="<?php echo $row['room_name']; ?>">
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="teacher_name" class="col-sm-3 text-right control-label col-form-label">اسم
                                الدكتور
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group ">
                            <label for="levelid" class=" col-sm-3 text-right control-label col-form-label"> البريد
                                المستوى </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group ">
                            <label for="building" class="col-sm-3 text-right control-label col-form-label"> رابط
                                المبنى
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group ">
                            <label for="course_id" class="col-sm-3 text-right control-label col-form-label"> رابط
                                المادة
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group ">
                            <label for="lecture_date" class="col-sm-3 text-right control-label col-form-label"> رابط
                                تاريخ المحاضرة
                            </label>
                            <div class="col-sm-9">
                                <input name="lecture_date" type="date" class="form-control" id="lecture_date"
                                    value="<?php echo $row['lecture_date']; ?>">
                            </div>
                        </div>

                        <div class="form-group ">
                            <label for="lecture_time" class="col-sm-3 text-right control-label col-form-label"> رابط
                                وقت المحاضرة
                            </label>
                            <div class="col-sm-9">

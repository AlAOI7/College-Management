					...
					<div>
						<section class="mt-3">
							<div class="btn btn-block table-one text-light d-flex">
								<span class="font-weight-bold"><i class="fa fa-clock-o mr-2" aria-hidden="true"></i> جدول المحاضرات</span>
					...
					<div>
						<section class="mt-3">
							<div class="btn btn-block table-two text-light d-flex">
								<span class="font-weight-bold"><i class="fa fa-list-alt mr-2" aria-hidden="true"></i> قائمة البرامج</span>
					...
					<div>
						<section class="mt-4">
							<div class="btn btn-block table-three text-light d-flex">
								<span class="font-weight-bold"><i class="fa fa-asterisk mr-2" aria-hidden="true"></i> تفلصيل موضوع القسم</span>
							...
							<div class="collapse show mt-2" id="collapsethree">
								<table class="w-100 table-elements table-three-tr"cellpadding="2">
									<tr class="pt-5 table-three text-white" style="height: 32px;">
										...
										<th>عنوان المنهج</th>
										<th>نصف السنه</th>
										<th>مجموع المواضيع </th>
										<th>اجمالي الساعات المعتمدة</th>
										<th> حذف</th>
									</tr>
									<?php  

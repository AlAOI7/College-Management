...
<div class="page-wrapper">
    <div class="row1">
        <div class="col-md-12">
            <div class="card">
                <form action="inc/update-newcollg.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <?php
                         if (isset($_POST['submit'])) {
                            ...
                            $sql = mysqli_query($conn, "INSERT INTO newcolleg (title, description,date,image,title1)
                            VALUES ('$title', '$description','$date', '$image','$title1')");
                            move_uploaded_file($_FILES['image']['tmp_name'], $target);
                            if ($sql) {
                                echo "<script> alert('اضافة الى صفحة الاخبار...!!!') </script>";
                                echo "<script> location = 'index_newcollg.php' </script>";
                            }
                        }
                        ?>
                        <?php
                        $sql = mysqli_query($conn, 'SELECT * FROM newcolleg');
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img  src="images/colleg/<?= $row['image'] ;?>" alt="image" style="width: 100px; height: 100px;">

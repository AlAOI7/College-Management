...
<?php  
  if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($conn, "INSERT INTO newdept (title,date, description,title1,image)
     VALUES ('$title','$date', '$description','$title1', '$image')");
    move_uploaded_file($_FILES['image']['tmp_name'], $target);
   

    if ($sql) {
      echo "<script> alert('اضافة خبر جديد...!!!') </script>";
        ...
        <div class="col-md-12">
            <div class="card">
                <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="card-body">
                        <h4 class="card-title">اضافة اخبار القسم </h4>
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-sm-3 text-right control-label col-form-label"> تاريخ النشر
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="title1" class="col-sm-3 text-right control-label col-form-label"> العنوان
                            </label>
                            <div class="col-sm-9">
